...
function DashBoard() {
  ...
  return (
    <div className="overflow-y-auto h-full p-4 gap-6 flex flex-col">
      <div
        style={{
          backgroundImage: `url(https://images.pexels.com/photos/7135053/pexels-photo-7135053.jpeg)`,
        }}
        className="w-full h-40 flex items-center p-4 justify-between rounded-lg"
      >
        <div>
      ...
      <div className="w-full h-full flex gap-4">
        <div className="w-3/5 shadow-md h-full rounded-lg">
          {" "}
          <DashGraph />{" "}
        </div>
        <div className="w-2/5 shadow-md h-full rounded-lg">
          {" "}
          <DashTasks />{" "}
        </div>
      </div>
