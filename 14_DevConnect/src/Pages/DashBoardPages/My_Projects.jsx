    ...
    <div className="p-6 flex flex-col gap-4 bg-gray-100 h-full">
      ...
      <div className="flex justify-between md:flex-row flex-col gap-4">
        ...
        <div className="flex gap-6">
          ...
          <button
            className={`border-2 w-fit px-2 py-1 rounded-md border-gray-300 ${showType === "In Progress" ? "border-purple-600 text-purple-600" : "border-gray-300 text-black"}`}
            onClick={() => setShowType("In Progress")}
          >
            In Progress
          </button>
          <button
            className={`border-2 w-fit px-2 py-1 rounded-md border-gray-300 ${showType === "Completed" ? "border-purple-600 text-purple-600" : "border-gray-300 text-black"}`}
      ...
      <div className="p-4">
        ...
        {searchValue && (
          <ShowSearchMyProject type={showType} value={searchValue} />
        )}
      </div>
    </div>
  );
